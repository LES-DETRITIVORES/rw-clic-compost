...
const ConfirmPage = () => {
  ...
  return (
  <>
    <MetaTags title="Confirmation" description="Page de confirmation de réservation de collecte" />
    ...
    <div className="flex flex-row">
      <div className="basis-full md:basis-1/2">
        ...
        <div className="container mx-auto max-w-xl font-sans bg-white rounded-lg shadow-lg p-8 mt-8 text-center">
          <p className="mt-6 font-bold text-lg">Votre demande de collecte est enregistrée.</p>
